...
scan_user_module_signatures(void)
{
  struct {
    ...
    SIG_ENTRY_NORMAL(DIRECT,     setup_signed_pak_reader,                 "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 41 54 41 55 41 56 41 57 48 83 EC ?? 80 B9 ?? ?? ?? ?? 00 4D 8B E0",                                                                               0x0400D950, 0x00000000),
    ...
    SIG_ENTRY_HOOKED(DIRECT,     ufunction_invoke,                        "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC ? 48 8B 59 ? 4D 8B F1",                                                                                                    0x0289B0B0, 0x00000000),
    ...
    SIG_ENTRY_HOOKED(DIRECT,     process_app_activation_event,            "48 89 6C 24 ? 56 48 83 EC ? 80 3D ? ? ? ? 00 48 8D B1",                                                                                                                                           0x02B57D70, 0x00000000),
    SIG_ENTRY_HOOKED(DIRECT,     d3d12_viewport_init,                     "48 89 74 24 ? 48 89 7C 24 ? 55 41 54 41 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 ? 4C 8B 69",                                                             0x02D44E20, 0x00000000),
    ...
    SIG_ENTRY_NORMAL(LEA_ADDR,   globals.natives,                         "48 8D 05 ? ? ? ? B9 ? ? ? ? 0F 1F 40 ? 66 0F 1F 84 00 ? ? ? ? ? ? ? 48 89 50 ? 48 89 50 ? 48 8D 40 ? 48 89 50 ? 48 89 50 ? 48 89 50 ? 48 89 50 ? 48 89 50 ? 48 83 E9 ? 75 ? 8B 05 ? ? ? ? 33 C9", 0x00A062C7, 0x00000000),
    ...
    SIG_ENTRY_NORMAL(DIRECT,     add_uobject_delete_listener,             "48 89 5C 24 ? 57 48 83 EC ? 48 8D 0D ? ? ? ? 48 8B FA FF 15",                                                                                                                                     0x02A0CFF0, 0x00000000),
    SIG_ENTRY_NORMAL(CALL_ARG,   tarray_grow,                             "E8 ? ? ? ? 48 8B 05 ? ? ? ? 48 8D 0D ? ? ? ? ? ? ? ? 48 8B 5C 24 ? 48 83 C4 ? 5F 48 FF 25 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? 40 53",                                                           0x02A0D029, 0x00000000),
    SIG_ENTRY_NORMAL(CALL_ARG,   tarray_shrink,                           "E8 ? ? ? ? 48 8D 0D ? ? ? ? 48 83 C4 ? 5B 48 FF 25 ? ? ? ? ? 8B 42",                                                                                                                              0x02A0D107, 0x00000000),
    SIG_ENTRY_NORMAL(DIRECT,     get_mcast_sparse_delegate,               "48 89 5C 24 ? 57 48 83 EC ? 48 8B F9 48 8B DA 48 8D 0D ? ? ? ? FF 15 ? ? ? ? 4C 8B C7",                                                                                                           0x02A06FF0, 0x00000000),
  };
