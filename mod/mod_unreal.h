...
MOD_STATIC_ASSERT(offsetof(uclass_t, class_ctor) == 0xB0, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_vftable_helper_ctor_caller_type) == 0xB8, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_and_ref_objs_type) == 0xC0, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_unique_and_cooked) == 0xC8, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_flags) == 0xCC, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_cast_flags) == 0xD0, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_within) == 0xD8, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_generated_by) == 0xE0, "invalid offset");
MOD_STATIC_ASSERT(offsetof(uclass_t, class_config_name) == 0xE8, "invalid offset");
...
/* ==================================================== FSTRING ===================================================== */
/*
 * Wraps UTF-16 data in an FString-shaped non-owning view without copying.
...
/* Returns a non-owning UTF-16 view of an FString, limited by its current length. */
str16_t
